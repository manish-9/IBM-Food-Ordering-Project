...
public class SendMail {
	...
	public static String send(String email, String link, String name) {
		...
		String to = "itsmeshivi07@gmail.com";
		...
		Session session = Session.getInstance(properties, new javax.mail.Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("itsmeshivi07@gmail.com", "Your-Password");	// pass the Gmail password as the 2nd argument
		...
		try {
			...
			String body = "Hello " + name
					...
					+ "\n\nYou are getting this mail in response to your Sign-Up request from FoodBasket!"
